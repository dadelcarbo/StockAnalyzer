...
namespace StockAnalyzer.StockClasses.StockViewableItems.StockIndicators
{
    public class StockIndicator_BB : StockIndicatorBase
    {
        ...
        public override string[] SerieNames => new string[] { "BBUp", "BBDown", this.parameters[3] + "(" + (int)this.parameters[0] + ")", "Signal" };
        ...
        public override void ApplyTo(StockSerie stockSerie)
        {
            ...
            stockSerie.GetSerie(StockDataType.CLOSE).CalculateBB(maSerie, (int)this.parameters[0], (float)this.parameters[1], (float)this.parameters[2], ref upperBB, ref lowerBB);
