...
{
   public class StockTrailStop_TRAILEMAEX : StockTrailStopBase
   {
      public StockTrailStop_TRAILEMAEX()
      {
      }
      public override string Definition
      {
         get { return "TRAILEMAEX(int SmoothPeriod,int InputSmoothing)"; }
      }
      ...
      public override string[] SerieNames { get { return new string[] { "TRAILEMAEX.LS", "TRAILEMAEX.SS" }; } }
