...
{
   public class StockPaintBar_ZIGZAGLINE : StockPaintBarBase
   {
      public StockPaintBar_ZIGZAGLINE()
      {
      }
      ...
      {
         get { return "ZIGZAGLINE(int hlPeriod)"; }
      }
      ...
      public override void ApplyTo(StockSerie stockSerie)
      {
         ...
         stockSerie.generateZigzagLines(0, stockSerie.Count - 1,
