...
{
    public class TrailPEMAAgent : StockAgentBase
    {
        public TrailPEMAAgent()
        {
            Period = 13;
        }
        ...
        public override string Description => "Buy with TRAILPEMA Stop";
        ...
        {
            trailStop = stockSerie.GetTrailStop($"TRAILPEMA({Period})");
