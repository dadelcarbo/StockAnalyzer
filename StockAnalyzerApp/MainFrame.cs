    ...
    public partial class StockAnalyzerForm : Form
    {
        ...
        private void BarDurationChanged(object sender, EventArgs e)
        {
            using (new MethodLogger(this))
            {
                ...
                ViewModel.SetBarDuration(
                    (BarDuration)barDurationComboBox.SelectedItem,
                    (int)barSmoothingComboBox.SelectedItem,
                    barHeikinAshiCheckBox.CheckBox.CheckState == CheckState.Checked,
                    (int)barLineBreakComboBox.SelectedItem,
                    true);
        ...
        private void OnBarDurationChanged()
        {
            ...
            {
                this.barDurationComboBox.SelectedItem = this.ViewModel.BarDuration.Duration;
                this.barSmoothingComboBox.SelectedItem = this.ViewModel.BarDuration.Smoothing;
                this.barHeikinAshiCheckBox.CheckBox.Checked = this.ViewModel.BarDuration.HeikinAshi;
                this.barLineBreakComboBox.SelectedItem = this.ViewModel.BarDuration.LineBreak;
            }
        ...
        public void GenerateIntradayAlert(List<StockBarDuration> barDurations)
        {
            using (new MethodLogger(this, showTimerDebug))
            {
                ...
                try
                {
                    ...
                    foreach (var alertDefGroup in alertDefs.GroupBy(a => a.Group))
                    {
                        var stockList = this.StockDictionary.Values.Where(s => s.BelongsToGroup(alertDefGroup.Key));
        ...
        /// <summary>
        /// Generate Intraday alerts for watchlist
        /// </summary>
        /// <param name="barDurations"></param>
        public void GenerateIntradayAlert(List<StockBarDuration> barDurations, string watchListName)
        {
            using (new MethodLogger(this, showTimerDebug))
            {
                // Alerts
                ...
                var wl = this.WatchLists.FirstOrDefault(w => w.Name == watchListName);
...
";
        ...
        void showAlertDialogMenuItem_Click(object sender, EventArgs e)
        {
            if (alertDlg == null)
            {
                alertDlg = new AlertDlg(StockAlertConfig.GetConfig(StockAlertTimeFrame.Intraday));
