...
namespace StockAnalyzer.StockDrawing
{
    ...
    public class HalfLine2D : Line2DBase
    {
        ...
        public HalfLine2D(PointF p1, PointF p2) : base(p1, p2)
        {
        }

        public HalfLine2D(PointF p1, PointF p2, Pen pen) : base(p1, p2, pen)
        {
        }
        public HalfLine2D(PointF p1, float vx, float vy) : base (p1, vx, vy)
        {
        }
