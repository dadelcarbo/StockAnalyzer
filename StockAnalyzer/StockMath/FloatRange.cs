namespace StockAnalyzer.StockMath
{
    ...
    public class FloatRange
    {
        ...
        /// <summary>
        /// Create a FloatRange having a value in the middle using accuracy to define boundaries
        /// </summary>
        /// <param name="value"></param>
        /// <param name="accuracy"></param>
        /// <returns></returns>
        static public FloatRange FromAccuracy(float value, float accuracy)
        {
            var epsilon = value * accuracy;
            return new FloatRange(value - epsilon, value + epsilon);
        }
