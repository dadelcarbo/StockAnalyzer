...
namespace StockAnalyzer.StockClasses
{
  ...
  bool amendOrders, bool supportShortSelling, bool takeProfit, float profitTarget, float fixedFee, float taxRate, StockPortofolio portofolio)
         ...
         float fixedFee, float taxRate, StockPortofolio portofolio, ref StockOrder stockOrder, StockOrder lastBuyOrder, bool lookingForBuying, float remainingCash, float benchmark)
      {
         ...
         var dailyValues = this.GetValues(StockBarDuration.Daily);
         ...
         if (this.StockTimeSpan == StockSerie.StockBarDuration.Daily)
         {
            ...
            switch (timeSpan)
            {
               ...
               case StockBarDuration.TLB_EMA20:
                  ...
                  break;
               case StockBarDuration.TLB_3D_EMA20:
                  newBarList = GenerateSmoothedBars(GenerateSerieForTimeSpan(dailyValueList, StockBarDuration.TwoLineBreaks_3D), 20);
                  break;
               case StockBarDuration.TLB_6D_EMA20:
                  newBarList = GenerateSmoothedBars(GenerateSerieForTimeSpan(dailyValueList, StockBarDuration.TwoLineBreaks_6D), 20);
                  break;
