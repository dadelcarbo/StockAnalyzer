...
#region Load component series
        ...
        public bool GenerateHigherThanHLTrailSerie(StockSerie breadthSerie, string indexName, string destinationFolder, string archiveFolder)
        {
            int period = int.Parse(breadthSerie.StockName.Split('.')[0].Replace("HL", ""));
             StockSerie indiceSerie = null;
            if (this.ContainsKey(indexName))
            {
                indiceSerie = this[indexName];
