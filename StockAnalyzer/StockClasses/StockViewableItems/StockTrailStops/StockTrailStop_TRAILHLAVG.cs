...
{
   public class StockTrailStop_TRAILHLAVG : StockTrailStopBase
   {
      public StockTrailStop_TRAILHLAVG()
      {
      }
      ...
      {
         get { return new string[] { "FadePeriod", "InputSmoothing" }; }
      }

      public override Object[] ParameterDefaultValues
      {
         get { return new Object[] { 50, 1 }; }
      }
      ...
      public override string[] SerieNames { get { return new string[] { "TRAILHLAVG.LS", "TRAILHLAVG.SS" }; } }
