...
{
    public class StockIndicator_ROR3 : StockIndicatorBase
    {
        public StockIndicator_ROR3()
        {
        }
        ...
        {
            get { return "ROR3(int LongPeriod, int MediumPeriod, int ShortPeriod, int Smoothing, int SignalSmoothing)"; }
        }
        ...
        public override string[] SerieNames
        {
            get
            {
                return new string[]
                {
                    "ROR3(" + this.Parameters[0].ToString() + "," + this.Parameters[1].ToString() + "," + this.Parameters[2].ToString()  + "," + this.Parameters[3].ToString() + ")",
        ...
        {
            FloatSerie rocSerie = (stockSerie.CalculateRateOfRise((int)this.parameters[0]) + stockSerie.CalculateRateOfRise((int)this.parameters[1]) + stockSerie.CalculateRateOfRise((int)this.parameters[2])).CalculateEMA((int)this.parameters[3]);
