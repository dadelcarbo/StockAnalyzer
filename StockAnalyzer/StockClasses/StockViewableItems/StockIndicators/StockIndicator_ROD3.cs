...
{
    public class StockIndicator_ROD3 : StockIndicatorBase
    {
        public StockIndicator_ROD3()
        {
        }
        ...
        {
            get { return "ROD3(int LongPeriod, int MediumPeriod, int ShortPeriod, int Smoothing, int SignalSmoothing)"; }
        }
        ...
        public override string[] SerieNames
        {
            get
            {
                return new string[]
                {
                    "ROD3(" + this.Parameters[0].ToString() + "," + this.Parameters[1].ToString() + "," + this.Parameters[2].ToString()  + "," + this.Parameters[3].ToString() + ")",
        ...
        {
            FloatSerie rocSerie = (stockSerie.CalculateRateOfDecline((int)this.parameters[0]) + stockSerie.CalculateRateOfDecline((int)this.parameters[1]) + stockSerie.CalculateRateOfDecline((int)this.parameters[2])).CalculateEMA((int)this.parameters[3]);
