...
{
   public class StockIndicator_EMAH : StockIndicatorBase
   {
      public StockIndicator_EMAH()
      {
      }
      ...
      {
         get { return "EMAH(" + this.Parameters[0].ToString() + ")"; }
      }

      public override string Definition
      {
         get { return "EMAH(int Period)"; }
      }
      ...
      public override string[] SerieNames { get { return new string[] { "EMAH(" + this.Parameters[0].ToString() + ")" }; } }
      ...
      public override void ApplyTo(StockSerie stockSerie)
      {
         ...
         FloatSerie maSerie = highSerie.CalculateEMA((int)this.parameters[0]);
