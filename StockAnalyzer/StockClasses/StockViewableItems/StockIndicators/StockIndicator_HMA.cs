    ...
    public class StockIndicator_HMA : StockIndicatorBase
    {
        ...
        public override void ApplyTo(StockSerie stockSerie)
        {
            ...
            for (int i = 2; i < maSerie.Count; i++)
            {
                ...
                this.eventSeries[10][i] = maSerie[i - 1] < maSerie[i];
                this.eventSeries[11][i] = maSerie[i - 1] > maSerie[i];
            }
        }

        static string[] eventNames = new string[] { "Bottom", "Top", "CrossAbove", "CrossBelow", "FirstBarAbove", "FirstBarBelow", "Bullish", "Bearish", "BullRun", "BearRun", "Rising", "Falling" };
