...
namespace StockAnalyzer.StockClasses.StockViewableItems.StockIndicators
{
   public class StockIndicator_TRUE : StockIndicatorBase, IRange
   {
      ...
      static string[] eventNames = new string[] { "True", "False", "HigherClose", "LowerClose", "RecHigherClose", "RecLowerClose", "EndOfHigherClose", "EndOfLowerClose", "BarComplete" };
      public override string[] EventNames
      {
         get { return eventNames; }
      }
      static readonly bool[] isEvent = new bool[] { false, false, true, true, false, false, true, true, false};
