...
{
    public class StockIndicator_VOLUM : StockIndicatorBase
    {
        public StockIndicator_VOLUM()
        {
        }
        ...
        {
            get { return "VOLUM(" + this.Parameters[0].ToString() + "," + this.Parameters[1].ToString() + "," + this.Parameters[2].ToString() + ")"; }
        }
        public override string Definition
        {
            get { return "VOLUM(int FastPeriod, int SmoothPeriod, int SignalPeriod)"; }
        }
