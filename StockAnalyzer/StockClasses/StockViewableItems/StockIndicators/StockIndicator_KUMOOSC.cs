...
{
    public class StockIndicator_KUMOOSC : StockIndicatorBase
    {
        ...
        {
            get { return new string[] { "TenkanSenPeriod", "KijunSenPeriod", "KumoPeriod" }; }
        }
        public override string[] SerieNames { get { return new string[] { "KUMOOSC(" + this.Parameters[0].ToString() + ")" }; } }
        ...
        public override void ApplyTo(StockSerie stockSerie)
        {
            ...
            var oscSerie = ichimoku.Series[2] - ichimoku.Series[3];
