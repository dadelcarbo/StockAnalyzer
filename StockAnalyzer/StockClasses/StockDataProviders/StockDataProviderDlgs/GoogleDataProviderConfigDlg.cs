...
{
   public partial class GoogleDataProviderConfigDlg : Form
   {
      GoogleDataProvider dataProvider = null;
      StockDictionary stockDictionary = null;

      bool needRestart = false;

      public GoogleDataProviderConfigDlg(StockDictionary stockDico)
      {
         InitializeComponent();

         this.dataProvider = new GoogleDataProvider();
