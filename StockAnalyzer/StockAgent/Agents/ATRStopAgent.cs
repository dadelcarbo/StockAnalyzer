...
namespace StockAnalyzer.StockAgent.Agents
{
    public class ATRStopAgent : StockAgentBase
    {
        ...
        public override string DisplayIndicator => $"TRAILSTOP|TRAILATR({Period},{Period},{Width},{-Width},EMA)";
        ...
        protected override bool Init()
        {
            if (DataSerie.Count < Period)
                return false;
            trailStop = DataSerie.GetTrailStop($"TRAILATR({Period},{Period},{Width},{-Width},EMA)");
